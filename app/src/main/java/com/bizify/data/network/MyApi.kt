...
interface MyApi {
    ...
    @GET("api/VehicleJoborder/SearchServicesbyVno?")
    suspend fun getOrderServiceList(@Header("Authorization") authHeader : String,@Query("V_NO") vno:String): Response<List<Services>>
